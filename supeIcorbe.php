...
<body>
    ...
    <div class="container mt-5 pt-5">
        ...
        <h2 class="border-bottom border-primary"> <strong> SUPE I ČORBE </strong> </h2>
        <!-- <hr> -->
        <p> Na ovoj internet stranici možete da pronađete najrazličitije recepte domaćih supa i čorbi. </p>
        ...
        <?php
            ...
            if ( $mysqli->connect_errno ) {
                ...
                $query = "SELECT * FROM ".$datatable." WHERE KATEGORIJA_JELA = 3 ORDER BY DATUM_UNOSA ASC LIMIT $start_from, ".$results_per_page;
                ...
                if ( $result == FALSE ) {
                    ...
                    $sql = "SELECT COUNT(*) AS total FROM ".$datatable." WHERE KATEGORIJA_JELA = 3";
                    ...
                    if ( $page == 1 ) {
                        ...
                        echo "<a class='page-link' href='supeIcorbe.php?page=".$prethodnaStrana."'>&laquo;</a>";
                        echo "</li>";
                    }
                    ...
                    for ( $i = 1; $i <= $total_pages; $i++ ) {  // ispisuje linkove za sve strane
                        if ( $i == $page ) {
                            ...
                            echo "<a href='supeIcorbe.php?page=".$i."'";
                    ...
                    if ( $page == $total_pages ) {
                        ...
                        echo "<li class='page-item'>";
                        echo "<a class='page-link' href='supeIcorbe.php?page=".$sledecaStrana."'>&raquo;</a>";
                        echo "</li>";
                    }
                }
                $mysqli->close();
