...
<body>
    ...
    <div class="container mt-5 pt-5">
        ...
        <h2 class="border-bottom border-primary"> <strong> PREDJELA </strong> </h2>
        <!-- <hr> -->
        <p> Na ovoj internet stranici možete da pronađete najrazličitije recepte domaćih predjela. </p>
        ...
        <?php
            ...
            if ( $mysqli->connect_error ) {
                ...
                $query = "SELECT * FROM ".$datatable." WHERE KATEGORIJA_JELA = 1 ORDER BY DATUM_UNOSA ASC LIMIT $start_from, ".$results_per_page;
                ...
                if ( $result == FALSE ) {
                    ...
                    $sql = "SELECT COUNT(*) AS total FROM ".$datatable." WHERE KATEGORIJA_JELA = 1";
                    ...
                    if ( $page == 1 ) {
                        ...
                        echo "<a class='page-link' href='predjela.php?page=".$prethodnaStrana."'>&laquo;</a>";
                        echo "</li>";
                    }
                    ...
                    for ( $i = 1; $i <= $total_pages; $i++ ) {  // ispisuje linkove za sve strane
                        echo "<li class='page-item'>";
                        echo "<a href='predjela.php?page=".$i."'";
                    ...
                    if ( $page == $total_pages ) {
                        ...
                        echo "<li class='page-item'>";
                        echo "<a class='page-link' href='predjela.php?page=".$sledecaStrana."'>&raquo;</a>";
                        echo "</li>";
                    }
                }
                $mysqli->close();
