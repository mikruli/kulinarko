...
<body>
    ...
    <div class="container mt-5 pt-5">
        ...
        <h2 class="border-bottom border-primary"> <strong> SALATE </strong> </h2>
        <!-- <hr> -->
        <p> Na ovoj internet stranici možete da pronađete najrazličitije recepte domaćih salata. </p>
        ...
        <?php
            ...
            if ( $mysqli->connect_errno ) {
                ...
                $query = "SELECT * FROM ".$datatable." WHERE KATEGORIJA_JELA = 6 ORDER BY DATUM_UNOSA ASC LIMIT $start_from, ".$results_per_page;
                ...
                if ( $result == FALSE ) {
                    ...
                    $sql = "SELECT COUNT(*) AS total FROM ".$datatable." WHERE KATEGORIJA_JELA = 6";
                    ...
                    if ( $page == 1 ) {
                        ...
                        echo "<a class='page-link' href='salate.php?page=".$prethodnaStrana."'>&laquo;</a>";
                        echo "</li>";
                    }
                    ...
                    if ( $page == $total_pages ) {
                        ...
                        echo "<li class='page-item'>";
                        echo "<a class='page-link' href='salate.php?page=".$sledecaStrana."'>&raquo;</a>";
                        echo "</li>";
                    }
                }
                $mysqli->close();
